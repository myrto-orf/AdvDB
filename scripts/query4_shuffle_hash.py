...
old_stdout9 = sys.stdout
new_stdout9 = io.StringIO()
sys.stdout = new_stdout9

join_strategies = ["shuffle_hash"]

for strategy in join_strategies:
    print(f"Executing query with {strategy} join strategy")
    query4_hne.query4(df, data5, strategy)

captured_output9 = new_stdout9.getvalue()

sys.stdout = old_stdout9

output_path9 = f"/home/user/opt/output/output9.csv"
with open(output_path9, 'w') as file:
    file.write(captured_output9)
