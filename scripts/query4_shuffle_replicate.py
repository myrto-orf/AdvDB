...
old_stdout10 = sys.stdout
new_stdout10 = io.StringIO()
sys.stdout = new_stdout10

join_strategies = ["shuffle_replicate_nl"]

for strategy in join_strategies:
    print(f"Executing query with {strategy} join strategy")
    query4_hne.query4(df, data5, strategy)

captured_output10 = new_stdout10.getvalue()

sys.stdout = old_stdout10

output_path10 = f"/home/user/opt/output/output10.csv"
with open(output_path10, 'w') as file:
    file.write(captured_output10)
