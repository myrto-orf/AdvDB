...
from queries import query3_hne
import io
import sys, time
...
new_stdout6 = io.StringIO()
sys.stdout = new_stdout6
...
captured_output6 = new_stdout6.getvalue()

sys.stdout = old_stdout6

output_path6 = f"/home/user/opt/output/output6.csv"
with open(output_path6, 'w') as file:
    file.write(captured_output6)
