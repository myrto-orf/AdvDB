...
old_stdout7 = sys.stdout
new_stdout7 = io.StringIO()
sys.stdout = new_stdout7

join_strategies = ["broadcast"] 

j = ["merge", "shuffle_hash", "shuffle_replicate_nl"]

for strategy in join_strategies:
    print(f"Executing query with {strategy} join strategy")
    query4_hne.query4(df, data5, strategy)

captured_output7 = new_stdout7.getvalue()

sys.stdout = old_stdout7

output_path7 = f"/home/user/opt/output/output7.csv"
with open(output_path7, 'w') as file:
    file.write(captured_output7)
